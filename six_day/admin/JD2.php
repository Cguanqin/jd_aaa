		...
		<div class="container">
			...
			<div class="first_box"> 
				<div class="row">
					...
					<div class="col-xs-3 pzbz_enter" "col-md-3">
						<a href=""></a>
					品质保障</div>
						...
						<div class="menu_left">
							<ul>
								...
								echo "<li>
									...
									<div>".$value['title']."</div>
									<div>";
									foreach($value['fruit'] as $key => $var){
										$shuzu = '|';
										if ((count($var)-1) == $key) {
											$shuzu ="";
										}
										echo"<a href=''>".$var.$shuzu."</a>";
									}
									"</div>
								</li>";
								}?>；
	...
	?>
						...
						<div id="slidershow" class="carousel">
							...
							<div class="carousel-inner">
								...
								<div class="item <?=$active?>">
									<img src="<?=$value['slider_img']?>" alt="">
									<!-- <li class="<?=$active?>" data-target="#slidershow" data-slide-to="<?=$key?>">1</li> -->
								</div>
				...
				foreach ($slider_a as $key => $value) {
					$active = $key==0?'active':'';
				?>
   								<li class="<?=$active?>" data-target="#slidershow" data-slide-to="<?=$key?>" ></li>
   			<?}?>
 							 </ol>
